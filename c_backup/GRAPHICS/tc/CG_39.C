	/* cg_39.c: Write a program to draw a a triangle. Take
	reflection along x-axis and then Rotate  by theta.
	 Use  Integer Generalised
	...
	void composite_transformation(int x1,int y1,int x2,int y2,int x3,int y3);
	...
	scanf("%d",&y3);
	printf("Enter value of theta in degree=");
	scanf("%f",&theta);
	...
	composite_transformation(x1,y1,x2,y2,x3,y3);
	...
	/* void composite_transformation(int x1,int y1,int x2,int y2,int x3,int y3)
	Function to apply rotation followed by reflection
	along x-axis. */
	...
	reflection_x(x1,y1,x2,y2,x3,y3);
	...
	rotation(xo1,yo1,xo2,yo2,xo3,yo3);

	triangle_draw(xo1,yo1,xo2,yo2,xo3,yo3);
	sprintf(a,"A2(%d,%d)",xo1,yo1);
	outtextxy(320+xo1,240-yo1,a);
	sprintf(a,"B2(%d,%d)",xo2,yo2);
	outtextxy(320+xo2,240-yo2,a);
	sprintf(a,"C2(%d,%d)",xo3,yo3);
	outtextxy(320+xo3,240-yo3,a);
