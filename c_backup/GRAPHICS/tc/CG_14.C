	/* cg_14.c: Write a program to draw 2 concentric  cicles
	   using Bresenham circle draw algorithm. */
	#include<stdio.h>
	#include<graphics.h>
	int c;
	int n;
	...
	scanf("%d",&r1);
	printf("Enter Radius of your 2nd circle(r2)=");
	scanf("%d",&r2);

	printf("\nEnter color code of line(1,2,3,4,5,15)=");
	scanf("%d",&c);
	draw_xy();
	circle_draw(xc,yc,r1); /* To draw 1st circle */
	circle_draw(xc,yc,r2); /* To draw 2nd circle */
