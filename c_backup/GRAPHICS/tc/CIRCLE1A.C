	/*circle1a.c: Write a program to draw a concentric circles using
	...
	scanf("%d",&line_color);
	draw_xy();
		for(i=r;i>=r-15;i=i-2)
		{
		circle_draw(xc,yc,i,line_color);
		delay(10);
	...
	/* void circle_draw(int xc,int yc,int r,int c) : Function to
	a circle */
	void circle_draw(int xc,int yc,int r,int c)
	{
	int x[1000],y[1000],i,n;
	char a[80];
