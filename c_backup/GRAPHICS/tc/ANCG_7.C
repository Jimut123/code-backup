	/*ancg_7.c: Write a program to apply translation on  a triangle */
	#include<stdio.h>
	#include<graphics.h>
	#include<math.h>
	int n,c;
	void draw_xy();
void trans(int x1,int y1,int x2,int y2,int x3,int y3,float sx,float sy);
...
void trans(int x1,int y1,int x2,int y2,int x3,int y3,float tx1,float ty1)
	{
	int i,j,k;
	char a[100];
	int x1s, y1s, x2s, y2s,x3s, y3s;
	/*float tx[3][3],t[3][3],p[3][3];*/
	x1s=x1+tx1;
	y1s=y1+ty1;
	x2s=x2+tx1;
	y2s=y2+ty1;
