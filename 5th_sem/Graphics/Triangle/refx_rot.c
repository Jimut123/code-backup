...
Draw that triangle and also two axes.
Apply composite transformations as follows:
(i) reflection along x-axis
(ii) rotation by 90 degree.
Display initial triangle and also the transformed triangles.*/
