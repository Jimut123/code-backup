/*Write a program in ‘’C”  to input co-ordinates of three vertices of a triangle ABC.
Draw that triangle and the 3 corners A,B,C with co-ordinates.
Apply the following transformations one after the other:
(i) Reflect along y-axis
(ii) Rotate the triangle by 45 degree around origin.
Draw final modified triangle.
Use different colors to draw 2-axes, 2 triangles.*/
