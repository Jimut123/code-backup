...
r1=fix(r/3);
r2=r-2*r1;
y1(1:r1,1:c,1:d)=x(1:r1,1:c,1:d);%1st 1/3 rd of image
y2(1:r1,1:c,1:d)=x(r1+1:2*r1,1:c,1:d);%2nd 1/3rd of image
y3(1:r2,1:c,1:d)=x(2*r1+1:r,1:c,1:d);%last 1/3rd part of image
...
yfinal(2*r1+1:r,1:c,1)=y3b(1:r1,1:c,1); 
yfinal(2*r1+1:r,1:c,2)=y3b(1:r1,1:c,1); 
yfinal(2*r1+1:r,1:c,3)=y3b(1:r1,1:c,1); 
%imshow(yfinal);
