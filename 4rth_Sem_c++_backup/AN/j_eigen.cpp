	//jacobi_eigen.cpp : Write a program to solve
	//eigen avlue equation using Jacobi method
	using namespace std;
	#include<iostream>
	#include<math.h>
	class Jacobi
...
itr=0;
		...
		//To create s1 matrix
			for(i=0;i<n;i++)
				for(j=0;j<n;j++)
					...
					s1[i][j]=0;
		//To find index of maximum value in off diagonal terms of
		//matrix a[][]
		i1=0;
		j1=1;
		maximum(a,&i1,&j1,n);
	...
	cout<<endl<<"Total number of iterations taken="<<itr<<endl;
	}
