	/* scalinga.c : Write a program to implement scaling transformation
	on a triangle.*/
...
/* void scaling(int x1,int y1,int x2,int y2,int x3,int y3,float sx,float sy) :
   ...
   void scaling(int x1,int y1,int x2,int y2,int x3,int y3,float sx,float sy)
	...
	outtextxy(360+x3,260-y3,"Before Scaling");
	...
	outtextxy(360+xm3,260-ym3,"After Scaling");
	}
