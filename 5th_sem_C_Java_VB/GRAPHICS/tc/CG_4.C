	/* cg_4.c: Write a program to draw a rectangle ABCD. Use DDA
...
void rectangle_draw(int x1,int y1,int x2,int y2,int x3,int y3,int x4,int y4)
	...
	line_draw(x,y,n,c);
	dda(x3,y3,x4,y4,x,y);/* To generate points from (x3,y3) to (x4,y4) */
	line_draw(x,y,n,c);
	dda(x4,y4,x1,y1,x,y);/* To generate points from (x4,y4) to (x1,y1) */
	line_draw(x,y,n,c);
	setcolor(1);
