	/* cg_6.c: Write a program to take reflecttion of a triangle
	along y-axis. Use DDA algorithm to draw a line. */
	#include<stdio.h>
	#include<graphics.h>
	int c;
	int n;
	...
	void reflection_y(int x1,int y1,int x2,int y2,int x3,int y3);
	void main()
	{
	...
	draw_xy();
	/*line_draw(x,y,n,c); */
	reflection_y(x1,y1,x2,y2,x3,y3);
	getch();
	closegraph();
	}
	...
	Function to take reflection of triangle along x-axis */
