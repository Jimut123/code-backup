	/* cg_16c.c: Write a program to draw a half circle y-axis wise
	  and then draw  its diameter.
	    */
	#include<stdio.h>
	#include<graphics.h>
	int c;
	...
	/* To draw half circle y-axis wise */
	...
	/* To draw a line from (n3,n3) to (3*n3,3*n3) */
