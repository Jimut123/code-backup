	/* ancg_26.c: Write a program to draw a cosec curve from -theta
	to +theta*/
	...
	void cosec_c(float theta1,float theta2);
	void main()
	{
	float theta1,theta2;
	char a[100];
	...
	/* void cosec_c(float theta1, float theta2) : Function to draw a
	cosec(x) curve */
	void cosec_c(float theta1,float theta2)
	{
	float x,y;
