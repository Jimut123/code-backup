	...
	/* rect_b1.c: Write a program to draw rectangle using Integer
	...
	int i,n,c;
	clrscr();
	printf("\nEnter co-ordinates of 4 corners of your rectangle--->\n");
	printf("\nEnter x1 of A=");
	scanf("%d",&x1);
	...
	scanf("%d",&y3);
	printf("Enter x4 of D=");
	scanf("%d",&x4);
	printf("Enter yy of D=");
	scanf("%d",&y4);
	...
	line_draw(x3,y3,x4,y4,c); /* To draw line CD */
	line_draw(x4,y4,x1,y1,c); /* To draw line DA */
	line_draw(x1,y1,x3,y3,c); /* To draw diagonal AC */
	line_draw(x4,y4,x2,y2,c); /* To draw reverse diagonal DB */
	outtextxy(320+x1,240-y1+5,"A");
	outtextxy(320+x2,240-y2+5,"B");
	outtextxy(320+x3,240-y3-10,"C");
	outtextxy(320+x4,240-y4-10,"D");
	getch();
	closegraph();
	}
