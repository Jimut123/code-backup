	/* ancg_12.c: Write a program to draw a triangle ABC.
	Draw a line  using Integer Bresenham Algorithm. Apply translation
   ...
   void translation(int x1,int y1,int x2,int y2,int x3,int y3,int tx,int ty);
	...
	scanf("%d",&tx);
	printf("Enter translation along y-axis(tx)=");
	scanf("%d",&ty);
