...
;
	...
	System.out.println(EnEnter input file name:
;
	s1=br.readLine();
	System.out.println(EnEnter output file name:
;
        s2=br.readLine();
...
;
	FileOutputStream fp2=new FileOutputStream(s2);
		...
		fp2.close();
		System.out.println(/Size of output file  Bytes.;zize of output file  Bytes.
;
	}
}
