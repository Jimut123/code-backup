/*Write a program to  draw a 4 thick circles in 4 different quadrants.
Join the centres of all circles with straight lines.
Use different colors to draw 4 circles and straight lines.
The user has to input radius and center of the circle of 1st quadrant.*/
