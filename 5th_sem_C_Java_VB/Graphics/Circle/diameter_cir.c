/*Write a program to draw a circle using bresenham circle draw algorithm and its two diameters.*/
...
void circle_draw(int xc,int yc,int r,int c)
{
  ...
  setcolor(2);
  sprintf(a,"D2(%d, %d)",xc+x[2*n3],yc+y[2*n3]);
  outtextxy(320+xc+x[2*n3],240-yc+y[2*n3],a);
