/*Write a program in ‘C’ to draw a rectangle ABCD where the user
has to input the co-ordinates of A,B,C and D.
Join two diagonals.
Draw a circle whose centre should coincide with point of intersection
of two diagonals and radius = ½ of breadth of the rectangle.
Choose different colors for drawing rectangle and the circle.
Display your roll number, name on screen.*/
...
int main()
{
    int x1,y1,x2,y2,x3,y3,x4,y4,xc,yc,r;
    clrscr();
