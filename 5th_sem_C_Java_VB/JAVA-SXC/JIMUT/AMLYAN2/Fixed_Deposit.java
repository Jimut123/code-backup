import java.io.*;
import java.lang.*; 
class Fixed_Deposit extends Bank
{
    int fd_no,inte;
    float amt,tot;
    void input()throws IOException
    {
        ...
        super.input();
        System.out.println("Enter the FD no. (int): ");
        fd_no = Integer.parseInt(cd.readLine());
        System.out.println("Enter the interest : (int)");
        inte = Integer.parseInt(cd.readLine());
        System.out.println("Enter the amount : (float)");
