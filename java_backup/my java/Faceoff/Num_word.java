...
class Num_word
{
    ...
    String s3[]={"ONE HUNDRED","TWO HUNDRED","THREE HUNDRED","FOUR HUNDRED","FIVE HUNDRED","SIX HUNDRED","SEVEN HUNDRED","EIGHT HUNDRED","NINE HUNDRED"};
     String s6[]={"ONE THOUSAND","TWO THOUSAND","THREE THOUSAND","FOUR THOUSAND","FIVE THOUSAND","SIX THOUSAND","SEVEN THOUSAND","EIGHT THOUSAND","NINE THOUSAND"};
    int i;
...
if(s5.equalsIgnoreCase("00")==false)
tens(s5);
 //s4=s3[0]+" "+s4;
}
else
...
void thousands(String k)
{
s5="";
if(k.charAt(0)=='0')
{
s5=s5+k.charAt(1)+k.charAt(2)+k.charAt(3);
if(s5.equalsIgnoreCase("000")==false)
hundreds(s5);
 //s4=s3[0]+" "+s4;
}
else
