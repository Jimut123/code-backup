...
String C[]={"English-I","English-II","Bengali","Maths","Physics","Chemistry","Biology","History&Civic","Geography","Computer","E.V.S","Hindi"};
...
System.out.println("Total:"+B[i][12]);
System.out.println("Percentage:"+B[i][13]);
